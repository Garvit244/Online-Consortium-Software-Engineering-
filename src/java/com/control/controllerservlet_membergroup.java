...
import javax.servlet.http.HttpSession;
	...
	public class controllerservlet_membergroup extends HttpServlet
	{
             @Override
		...
		{  
			...
			String uid=request.getParameter("uid");    
                        System.out.println("Inside membergroup:"+uid);
                        ...
                        {
                            RequestDispatcher rd=request.getRequestDispatcher("select_group.jsp");  
                        ...
                        else if(status_checkgroup == 2)
                        {
                            ...
                            out.println("alert('Only an admin can add members to a group!');");
