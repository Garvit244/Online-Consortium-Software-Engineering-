...
<div id='cssmenu'>
<ul name="lg">
   <li class='active'><a href='Register_User.jsp'><span>Home</span></a></li>
   <li class='has-sub'><a href='#'>
      ...
      <ul>
         <li id="editprofile"><a href='profile_edit.jsp'><span>Edit Profile</span></a></li>
         <li id="viewprofile"><a href='#'><span>View Profile</span></a></li>
         <li class='last'><a href='index.jsp'><span>Log Out</span></a></li>
      </ul>
   </li>
   <li class='has-sub'><a href='#'><span>Document</span></a>
      <ul name="doc">
         <li id="upload"><a href='#'><span>Upload</span></a></li>
         <li id="viewmydocument"><a href='#'><span>View Document</span></a></li>
         <li class='last' id="modifydocument"><a href='#'><span>Modify Details</span></a></li>
      </ul>
   </li>
   <li class='has-sub last'><a href='#'><span>Group</span></a>
      <ul>
         <li id ="creategroup" class='#'><a href='#'><span>Create Group</span></a></li>
		 <li id ="mygroups" class='#'><a href='#'><span>My Groups</span></a></li>
		 <li id="deletegroup" ><a href='#'><span>Delete Groups</span></a></li>
                 <li class='last'><a href="${pageContext.request.contextPath}/controllerservlet_membergroup?uid=<%out.print(Uname);%>"><span>Add Members</span></a></li>
      </ul>
   </li>
</ul>
</div>
